...
def model(theta, observations):
    thetaObs, thetaCore, epsilon_e, epsilon_b, E0 = theta
    thetaWing = 0.4
    p=2.2
    n0=1.0e-3
    # Jet Parameters
...
initial_guess = np.array([0.065, 0.02, 0.005, 0.05, 5.11e51])
ndim = len(initial_guess)
# Define a scale for each parameter (a fraction of its typical value)
scale = np.array([0.01, 0.01, 0.001, 0.01, 1e50])
...
paramnames = ['thetaObs', 'thetaCore', 'epsilon_e', 'epsilon_b', 'E0']
# Print them
